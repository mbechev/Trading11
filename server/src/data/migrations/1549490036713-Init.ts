...
export class Init1549490036713 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<any> {
        ...
        await queryRunner.query("CREATE TABLE `funds` (`id` varchar(255) NOT NULL, `currentamount` decimal(10,4) NOT NULL DEFAULT 0, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `orders` (`id` varchar(255) NOT NULL, `opendate` datetime NOT NULL, `closedate` datetime NULL, `openPrice` decimal(10,4) NOT NULL, `closePrice` decimal(10,4) NULL, `units` decimal(10,4) NOT NULL, `result` decimal(10,4) NULL, `direction` varchar(255) NOT NULL, `clientId` varchar(255) NULL, `companyId` varchar(255) NULL, `statusId` varchar(255) NULL, PRIMARY KEY (`id`)) ENGINE=InnoDB");
        ...
        await queryRunner.query("CREATE TABLE `companies` (`id` varchar(255) NOT NULL, `name` varchar(255) NOT NULL DEFAULT '', `abbr` varchar(255) NOT NULL DEFAULT '', `closedate` datetime NOT NULL, `industryId` varchar(255) NULL, UNIQUE INDEX `IDX_3dacbb3eb4f095e29372ff8e13` (`name`), PRIMARY KEY (`id`)) ENGINE=InnoDB");
